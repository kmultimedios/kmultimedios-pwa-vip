/**
 * Service Worker – KMultimedios VIP Android (vaderapp)
 */

const CACHE_VERSION = 'km-vip-android-v1.0.0';
...
function offlinePage() {
  return caches.match('/vaderapp/offline.html').then(
...
self.addEventListener('notificationclick', (event) => {
  ...
  event.waitUntil(clients.openWindow(event.notification.data?.url ?? '/vaderapp/'));
});
